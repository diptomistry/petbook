...
import 'package:petbook/message/chatcontroller.dart';
import '../home.dart';
...
class _ChatDetailPageState extends State<ChatDetailPage> {
  ...
  void readLocal() async {
    ...
    setState(() {
      currentUserId = widget.data.id == "hORnW8OnMbGAHw1E2i6e"
          ? a.docs[0].id
          : a.docs[1].id;
    });
    String peerId =
    widget.data.id != "hORnW8OnMbGAHw1E2i6e" ? a.docs[0].id : a.docs[1].id;
